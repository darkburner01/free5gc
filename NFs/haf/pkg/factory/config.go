...
const (
	HafDefaultTLSKeyLogPath      = "./log/hafsslkey.log"
	HafDefaultCertPemPath        = "./cert/haf.pem"
	HafDefaultPrivateKeyPath     = "./cert/haf.key"
	HafDefaultConfigPath         = "./config/hafcfg.yaml"
	HafSbiDefaultIPv4            = "127.0.0.9"
	HafSbiDefaultPort            = 8000
	HafSbiDefaultScheme          = "https"
	HafDefaultNrfUri             = "https://127.0.0.10:8000"
	HafSorprotectionResUriPrefix = "/nhaf-sorprotection/v1"
	HafAuthResUriPrefix          = "/nhaf-auth/v1"
	HafUpuprotectionResUriPrefix = "/nhaf-upuprotection/v1"
)
...
func (c *Configuration) validate() (bool, error) {
	...
	for index, serviceName := range c.ServiceNameList {
		switch {
		case serviceName == "nhaf-auth":
		default:
			err := errors.New("Invalid serviceNameList[" + strconv.Itoa(index) + "]: " +
				serviceName + ", should be nhaf-auth.")
			return false, err
		}
	}
